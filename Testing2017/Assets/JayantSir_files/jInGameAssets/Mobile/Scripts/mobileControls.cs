...
public class mobileControls : MonoBehaviour, IDragHandler, IPointerUpHandler, IPointerDownHandler {//need that for mobile controls
	...
	private GameController outsideControls;// making a link to corresponding bike's script
	...
	private void Start(){
		...
		outsideControls = ctrlHub.GetComponent<GameController>();// making a link to corresponding bike's script
