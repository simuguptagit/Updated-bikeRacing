...
private var bikeStatusCrashed : BikeMainLogic;// making a link to corresponding bike's script
//why it's here ? because you might use this script with many bikes in one scene

private var ctrlHub : GameObject;// gameobject with script control variables 
private var outsideControls : GameController;// making a link to corresponding bike's script

function Start () {

ctrlHub = GameObject.Find("gameScenario");//link to GameObject with script "controlHub"
outsideControls = ctrlHub.GetComponent(GameController);//to connect c# mobile control script to this one
...
bikeStatusCrashed = bikeRideOn.GetComponent(BikeMainLogic);
