...
public class camSwitcher : MonoBehaviour
{
	...
	public Transform[] AllcameraTarget;
	...
	void Start ()
	{
		...
		bikeNo=GameController.BikeNo;
		switch (bikeNo) {
		case 1:
			cameraTarget = AllcameraTarget [0];
			break;
		case 2:
			cameraTarget = AllcameraTarget [1];
			break;
		case 3:
			cameraTarget = AllcameraTarget [2];
			break;
